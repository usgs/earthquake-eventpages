...
describe('moment-tensor/MomentTensorPinViewTest', function () {
  describe('constructor', function () {
    it('should be defined', function () {
      expect(typeof MomentTensorPinView).to.equal('function');
    });
  });

  describe('renderPinContent', function () {
    it('renders beachball correctly', function () {
      var view;

      view = MomentTensorPinView({
        model: product
      });
