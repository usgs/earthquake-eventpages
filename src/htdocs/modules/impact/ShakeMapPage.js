    ...
    '<table class="station-channels tabular">',
      '<thead>',
        '<tr>',
          ...
          '<th scope="col" class="station-channels-pga">pga %g</th>',
          '<th scope="col" class="station-channels-pgv">pgv cm/s</th>',
          '<th scope="col" class="station-channels-psa03">psa03 %g</th>',
          '<th scope="col" class="station-channels-psa10">psa10 %g</th>',
          '<th scope="col" class="station-channels-psa30">psa30 %g</th>',
        '</tr>',
      '</thead>',
      '<tbody>'
  ];
